...
COPY ./superset-frontend/package* ./
...
COPY --chown=superset:superset ./requirements/local.txt ./requirements/local.txt
COPY --chown=superset:superset ./requirements/development.txt ./requirements/development.txt
